...
const topScorer = computed(() => {
  ...
  scores.sort((a, b) => {
    const scoreA = (props.numofquestion / (a.total_time ? a.total_time : 100000000000000)) * a.total_point
    const scoreB = (props.numofquestion / (b.total_time ? b.total_time : 100000000000000)) * b.total_point
        ...
        <v-sheet class="rounded-xl pa-3">
          <div class="d-flex justify-space-between">
            ...
            <div class="d-flex justify-space-between">
              ...
              <div>{{ row.total_point }} <v-icon size="x-small" icon="i-mdi-star-outline" /></div>
            </div>
          </div>
        </v-sheet>
      </div>
