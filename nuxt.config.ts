...
export default defineNuxtConfig({
  ...
  modules: ['@nuxt/eslint', '@nuxt/test-utils', '@nuxt/image', 'vuetify-nuxt-module', 'dayjs-nuxt', '@pinia/nuxt', '@unocss/nuxt', '@vite-pwa/nuxt', '@nuxtjs/device', '@nuxtjs/storybook'],
  pwa: {
